...
Copy jar file to Job execution home directory(specified in wrapper script). If you want it to run from a different location and/or need to change the jar name, update the JAR file path in wrapper script 
